...
--CREATE TABLE doacao (
--    id                      BIGSERIAL PRIMARY KEY,
--    id_bancos_de_leite      BIGINT NOT NULL,  -- nome da coluna no plural, conforme solicitado
...
--    id                  BIGSERIAL PRIMARY KEY,
--    id_bancos_de_leite  BIGINT NOT NULL,  -- padronizado com o mesmo nome
--    codigo              VARCHAR(50) NOT NULL,
--    datahora_envio      TIMESTAMP WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP NOT NULL,
--    mensagem            VARCHAR(255) NOT NULL,
--    CONSTRAINT fk_notificacao_banco FOREIGN KEY (id_bancos_de_leite) REFERENCES banco_de_leite(id)
--);
--
---- ==========================================
---- TABELA TOKEN DE RECUPERAÇÃO
---- ==========================================
